...
-(void)prepareData{
    ...
    self.themeArray = @[[UIColor clmHex:0X1abc9c],
                        [UIColor clmHex:0X27ae60],
                        [UIColor clmHex:0X2980b9],
                        [UIColor clmHex:0X2c3e50],
                        [UIColor clmHex:0Xf39c12],
                        [UIColor clmHex:0Xc0392b],
                        [UIColor clmHex:0X7f8c8d],
                        [UIColor clmHex:0X8e44ad]];
...
-(void)initWindow:(AlertStyle)style{
  ...
  //  [self animateSenior];
    [self animationAlert:self.mainView];
    [self prepareData];
}
...
-(void)animateSenior{
  ...
  self.mainView.transform = CGAffineTransformMakeTranslation(0, 600);
    [UIView animateWithDuration:0.2 delay:0 usingSpringWithDamping:0.35 initialSpringVelocity:0.5 options:UIViewAnimationOptionCurveEaseIn animations:^{
...
-(void)confirmButtonClick:(UIButton*)sender{
    ...
    if ([self.delegate respondsToSelector:@selector(RalertView:clickedButtonAtIndex:)]) {
        [self.delegate RalertView:self clickedButtonAtIndex:sender.tag];
    }
...
-(UIButton *)confirmButton{
    if(_confirmButton == nil){
        ...
        [_confirmButton setBackgroundColor:[UIColor clmHex:0Xfddb43]];
        [_confirmButton setTitle:@"Ok" forState:UIControlStateNormal];
        [_confirmButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_confirmButton setTitleColor:[UIColor clmHex:0X3d3d3d] forState:UIControlStateNormal];
        [_confirmButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
        [_confirmButton addTarget:self action:@selector(confirmButtonClick:) forControlEvents:UIControlEventTouchUpInside];
        _confirmButton.tag=11;
    }
...
-(UIButton *)cancelButton{
    if(_cancelButton == nil){
        ...
        [_cancelButton setBackgroundColor:[UIColor clmHex:0XEBECED]];
        [_cancelButton setTitle:@"Cancel" forState:UIControlStateNormal];
        [_cancelButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_cancelButton setTitleColor:[UIColor clmHex:0X3d3d3d] forState:UIControlStateNormal];
...
-(UILabel*)headerTitleLabel {
    if (_headerTitleLabel == nil) {
        ...
        [_headerTitleLabel setTextColor:[UIColor clmHex:0X3d3d3d]];
    }
...
-(UILabel*)contentTextLabel {
    if (_contentTextLabel == nil) {
        ...
        [_contentTextLabel setTextColor:[UIColor clmHex:0X898989]];
